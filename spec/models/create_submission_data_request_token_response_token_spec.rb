...
# Unit tests for DocSpring::CreateSubmissionDataRequestTokenResponseToken
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CreateSubmissionDataRequestTokenResponseToken' do
  before do
    # run before each test
    @instance = DocSpring::CreateSubmissionDataRequestTokenResponseToken.new
  end
  ...
  describe 'test an instance of CreateSubmissionDataRequestTokenResponseToken' do
    it 'should create an instance of CreateSubmissionDataRequestTokenResponseToken' do
      expect(@instance).to be_instance_of(DocSpring::CreateSubmissionDataRequestTokenResponseToken)
    end
  end
